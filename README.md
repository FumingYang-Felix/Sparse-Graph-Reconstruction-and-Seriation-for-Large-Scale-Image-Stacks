...
>
  <!-- 源 1：GitHub user-attachments（你刚给的地址） -->
  <source src="https://github.com/user-attachments/assets/21337423-d7ec-4a56-8655-532e713e6a49" type="video/mp4" />
  <!-- 源 2：仓库 raw 直链（同名 mp4 在根目录） -->
